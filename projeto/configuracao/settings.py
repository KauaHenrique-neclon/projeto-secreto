...
SECRET_KEY = 'django-insecure-hktsyvlgbvaaohg=_*fgnmyx(^-88ip=cskk4209a@zoa*w7v)'
...
STATIC_URL = 'static/'
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'app/static'), # parametro para a pasta static, onde fica os arquivos estaticos
    os.path.join(BASE_DIR, 'staticMidia'),
